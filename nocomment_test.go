...
func TestClean(t *testing.T) {
	codeList := [][]string{
		...
		{"#this is a comment\nHello World# another comment\n", "\nHello World\n"},
		{"#this is a comment\r\nHello World# another comment\r\n", "\r\nHello World\r\n"},
		{"`#this is not a comment` Hello World", "`#this is not a comment` Hello World"},
		{"`#this is not a comment````` Hello World", "`#this is not a comment````` Hello World"},
		{"#`this is a comment`\r\nHello World", "\r\nHello World"},
		{"-- this is a comment\nHello World-- another comment\n", "\nHello World\n"},
		{"-- this is a comment\r\nHello World-- another comment\r\n", "\r\nHello World\r\n"},
		{"-- this is a comment\rHello World-- another comment\r", "\rHello World\r"},
		{"--\nthis is a comment\nHello World--\tanother comment\n", "\nHello World\n"},
